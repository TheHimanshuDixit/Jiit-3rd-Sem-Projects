...
<div class="container" style="margin-bottom: 150px;">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php endif; ?>
            <h1 style="font-family: timesnewroman;text-align :center; margin-bottom:40px;text-decoration:underline"><i>Add new Donor</i></h1>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" style="vertical-align: center;">
                            ...
                            <input style="margin-left: 80px;" type="radio" value="female" name="sex">Female
                        </div>
                        <div class="form-group">
...
<footer style="opacity: 0.9; z-index : -1">
    <b>Made By: <br><a>Himanshu Dixit 21103262 &nbsp;&nbsp;&nbsp;&nbsp;</a><a>Kamal Garg 21103231 &nbsp;&nbsp;&nbsp;&nbsp;</a><a>Srishti Garg 211032 &nbsp;&nbsp;&nbsp;&nbsp;</a><a>Rhythm Srivastav 211032</a></b>
    <br>
    &COPY;DSWProject
</footer>
