...
<h1 style="font-family: timesnewroman;text-align :center; margin-bottom:40px;text-decoration:underline"><i>Check the Availability of Donors</i></h1>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <form class="form-inline" role='form' method="post" action="availability.php">
                <label class="form-label" style="font-size: 20px; margin-right: 20px">Select Blood Group: </label>
